    ...
    <div class="row">
        <section class="col-lg-12 ">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <!-- Modal -->
                    <form action="<?php echo base_url('operator/tambahsuplier') ?>" method="post">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo base_url('operator/suplieredit/' . $d->suplier_id) ?>" method="post">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url() . 'operator/hapussiplier/' . $d->suplier_id ?>" class="btn btn-warning">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
