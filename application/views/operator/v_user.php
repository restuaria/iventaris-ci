        ...
        <section class="col-lg-10 col-lg-offset-1">
            <div class="box box-info">
                <div class="box-header">
                    ...
                    ?>
                    <a href="<?php echo base_url('operator/user_tambah') ?>" class="btn btn-warning btn-sm pull-right"><i class="fa fa-plus"></i> &nbsp TAMBAH DATA PENGGUNA</a>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'operator/user_edit/' . $d->user_id ?>"><i class="fa fa-edit"></i></a>
                                            <?php if ($d->user_id != 1) { ?>
                                                <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="<?php echo base_url('operator/user_hapus/' . $d->user_id) ?>"><i class="fa fa-trash"></i></a>
