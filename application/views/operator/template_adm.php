...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('operator') ?>" class="logo">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            <li>
                                <a href="<?php echo base_url("operator/databarang") ?>">
                                    <i class="fa fa-folder"></i> <span>Data Barang</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("operator/barangkeluar") ?>">
                                    <i class="fa fa-mail-forward"></i> <span>Barang Keluar</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("operator/barangmasuk") ?>">
                                    <i class="fa fa-mail-reply"></i> <span>Barang Masuk</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("operator/peminjaman") ?>">
                    ...
                    <li>
                        <a href="<?php echo base_url("operator/prasarana") ?>">
                            <i class="fa fa-book"></i> <span>PRASARANA</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url("operator/lokasi_sebaran") ?>">
                    ...
                    <li>
                        <a href="<?php echo base_url('operator/gantipassword') ?>">
