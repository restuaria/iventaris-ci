            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url("operator/tambahbarangkeluar") ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> &nbsp TAMBAH DATA</a>
                        <a href="<?php echo base_url('operator/barangkeluarpdf') ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                        <a href="<?php echo base_url('operator/barangkeluarexcel') ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                    </div>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'operator/editbarangkeluar/' . $d->bk_id ?>"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#konfirmasi_batal" data-href="<?php echo base_url() . 'operator/hapusbk/' . $d->bk_id ?> "><i class='fa fa-trash'></i></a>
