        ...
        <section class="col-lg-6 col-lg-offset-3">
            <div class="box box-info">
                <div class="box-header">
                    <a href="<?php echo base_url('operator/user') ?>" class="btn btn-warning btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp; Kembali</a>
                </div>
                <div class="box-body">
                    <?php
                    foreach ($user as $d) {
                    ?>
                        <form action="<?php echo base_url("operator/user_proses_e/$d->user_id") ?>" method="post" enctype="multipart/form-data">
