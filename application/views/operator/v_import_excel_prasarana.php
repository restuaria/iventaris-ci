<section class="content-header">
    <h1>
        Upload Excel PRASARANA
        <small>Upload Excel PRASARANA</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Upload Excel PRASARANA</li>
    </ol>
</section>
            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url("operator/prasarana") ?>" class="btn btn-success btn-sm  mb-3 float-right"><i class="fa fa-users"></i> &nbsp LIHAT DATA Barang</a>
                    </div>
                ...
                <div class="box-body">
                    <fieldset>
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('operator/importpra') ?>">
