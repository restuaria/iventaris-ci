                ...
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <div class="btn-group pull-right">
                            <a href="<?php echo base_url('admin/prasarana_pdf') ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                            <a href="<?php echo base_url('admin/prasarana_excel') ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                        </div>
                    </div>
                    <div class="box-body">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url() . 'admin/hapusprasarana/' . $d->barang_id ?>" class="btn btn-warning">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
