            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url('admin/prasarana_pdf_filter/' . $fa) ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                        <a href="<?php echo base_url('admin/prasarana_excel_filter/' . $fa) ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                    </div>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="<?php echo base_url() . 'admin/prasaranadetail/' . $d->barang_id ?>"><i class="fa fa-folder"></i></a>
                                            <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'admin/prasaranaedit/' . $d->barang_id ?>"><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="barang_prasarana_hapus.php?id=<?php echo $d->barang_id ?>" class="btn btn-warning">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
