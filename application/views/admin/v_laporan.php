            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    ?>
                        ...
                        ?>
                            <a href="<?php echo base_url() . 'admin/laporan_pdf' ?>?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&jenis=<?php echo $jenis ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                            <br /><br />
