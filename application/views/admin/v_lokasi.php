    ...
    <div class="row">
        <section class="col-lg-8 col-lg-offset-2">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <!-- Modal -->
                    <form action="<?php echo base_url('admin/lokasi_tambah') ?>" method="post">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo base_url('admin/lokasi_edit') ?>" method="post">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url() . 'admin/lokasi_hapus/' .  $d->fakultas_id ?>" class="btn btn-warning">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
