            ...
            <section class="col-lg-12">
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        ?>
                        <form method="post" action="<?php echo base_url("admin/filterbarang") ?>">
                            <div class="form-group">
                                <label><b>FILTER DATA</b></label>
                                <select name="fakultas" class="form-control" required="required">
                                    <option value=""> - Pilih Lokasi - </option>
                                    <?php
                                    $fakultas = $this->db->query("SELECT * FROM fakultas where fakultas_id < 6 order by fakultas_nama asc");
                        ...
                        <div class="btn-group pull-right">
                            <a href="<?php echo base_url("admin/barangpdf") ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                            <a href="<?php echo base_url("admin/barangexcel") ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                        </div>
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="<?php echo base_url() . 'admin/barangdetail/' . $d->barang_id ?>"><i class="fa fa-folder"></i></a>
                                                <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'admin/barang_edit/' . $d->barang_id ?>"><i class="fa fa-edit"></i></a>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url() . 'admin/hapus_barang/' . $d->barang_id ?>" class="btn btn-warning">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
