            ...
            <section class="col-lg-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <br /><br />
                        <div class="box-header">
                            <a href="<?php echo base_url('admin/lokasi_sarana_pdf') ?>" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a> <br /><br />
                        ...
                        <br /><br />
                        <div class="box-header">
                            <a href="<?php echo base_url('admin/lokasi_prasarana_pdf') ?>" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a> <br /><br />
