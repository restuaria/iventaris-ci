    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('admin/databarang') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('admin/prasarana') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-primary">
                ...
                <a href="<?php echo base_url('admin/barangmasuk') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-primary">
                ...
                <a href="<?php echo base_url('admin/barangkeluar') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-blue">
                ...
                <a href="barang_keluar.php" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('admin/peminjaman') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-green">
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-yellow">
                <div class="inner">
                    <?php
                    $user = $this->db->query("SELECT * FROM user")->num_rows();
                    ?>
                    <h3><?php echo $user ?></h3>
                    <p>Data Pengguna</p>
                </div>
                ...
                <a href="<?php echo base_url('admin/user') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
