            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url('admin/peminjamanpdf') ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                        <a href="<?php echo base_url('admin/peminjamanexcel') ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                    </div>
                </div>
                <div class="box-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        ?>
                                                            <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#konfirmasi_selesai" data-href="<?php echo base_url() . 'admin/pinjamupdate/' . $d->pinjam_id ?> "><i class='fa fa-inbox'></i></a>
                                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#konfirmasi_batal" data-href="<?php echo base_url() . 'admin/pinjamhapus/' . $d->pinjam_id ?> "><i class='fa fa-close'></i></a>
