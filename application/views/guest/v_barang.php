            ...
            <section class="col-lg-12">
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        ?>
                        <form method="post" action="<?php echo base_url("guest/filterbarang") ?>">
                        ...
                        <div class="btn-group pull-right">
                            <a href="#" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                            <a href="#" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                        </div>
                    </div>
                    <div class="box-body">
