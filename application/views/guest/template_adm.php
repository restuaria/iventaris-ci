...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('guest') ?>" class="logo">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            <li>
                                <a href="<?php echo base_url("guest/databarang") ?>">
                                    <i class="fa fa-folder"></i> <span>Data Barang</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("guest/barangkeluar") ?>">
                                    <i class="fa fa-mail-forward"></i> <span>Barang Keluar</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("guest/barangmasuk") ?>">
                                    <i class="fa fa-mail-reply"></i> <span>Barang Masuk</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("guest/peminjaman") ?>">
                                    <i class="fa fa-hand-paper-o"></i> <span>Peminjaman</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("guest/suplier") ?>">
                    ...
                    <li>
                        <a href="<?php echo base_url("guest/prasarana") ?>">
